...
HD_PWD='D:/proyecto_integrador/rtl_projects/test_board/please_work.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log please.vdi -applog -m64 -messageDb vivado.pb -mode batch -source please.tcl -notrace
