...
HD_PWD='D:/proyecto_integrador/rtl_projects/test_board/please_work.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log please.vds -m64 -mode batch -messageDb vivado.pb -notrace -source please.tcl
