...
HD_PWD='D:/proyecto_integrador/rtl_projects/simple_adder/simple_adder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log simple_adder.vds -m64 -mode batch -messageDb vivado.pb -notrace -source simple_adder.tcl
