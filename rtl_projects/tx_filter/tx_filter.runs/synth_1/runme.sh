...
HD_PWD='D:/proyecto_integrador/rtl_projects/tx_filter/tx_filter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tx_filter.vds -m64 -mode batch -messageDb vivado.pb -notrace -source tx_filter.tcl
