...
HD_PWD='D:/proyecto_integrador/rtl_projects/mixer/mixer.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_mixer.vds -m64 -mode batch -messageDb vivado.pb -notrace -source top_mixer.tcl
