...
HD_PWD='D:/proyecto_integrador/rtl_projects/sin_ram/sin_ram.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sin_ram.vds -m64 -mode batch -messageDb vivado.pb -notrace -source sin_ram.tcl
