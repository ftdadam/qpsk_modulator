...
HD_PWD='D:/proyecto_integrador/rtl_projects/tx_top/tx_top.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tx_top.vds -m64 -mode batch -messageDb vivado.pb -notrace -source tx_top.tcl
