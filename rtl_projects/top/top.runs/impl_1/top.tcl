...
set rc [catch {
  ...
  set_property ip_repo_paths d:/proyecto_integrador/rtl_projects/top/top.cache/ip [current_project]
  set_property ip_output_repo d:/proyecto_integrador/rtl_projects/top/top.cache/ip [current_project]
  add_files -quiet D:/proyecto_integrador/rtl_projects/top/top.runs/synth_1/top.dcp
